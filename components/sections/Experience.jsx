                                ...
                                <div className="row mt-5">
                                    <div className="col-lg-4">
                                        <div className="d-flex flex-column gap-2">
                                            <Link to="#" className="technology border border-1 rounded-3 p-3">
                                                <div className="d-flex align-items-center gap-2">
                                                    <img src="assets/imgs/home-page-2/experience/google.svg" alt="khizar" />
                                            ...
                                            <Link to="#" className="technology border border-1 rounded-3 p-3">
                                                <div className="d-flex align-items-center gap-2">
                                                    <img src="assets/imgs/home-page-2/experience/twitter.svg" alt="khizar" />
                                                    <div className="d-flex flex-column ms-2">
                                            ...
                                            <Link to="#" className="technology border border-1 rounded-3 p-3">
                                                <div className="d-flex align-items-center gap-2">
                                                    <img src="assets/imgs/home-page-2/experience/amazon.svg" alt="khizar" />
                                                    <div className="d-flex flex-column ms-2">
                                            ...
                                            <Link to="#" className="technology border border-1 rounded-3 p-3">
                                                <div className="d-flex align-items-center gap-2">
                                                    <img src="assets/imgs/home-page-2/experience/payPal.svg" alt="khizar" />
                                                    <div className="d-flex flex-column ms-2">
                                    ...
                                    <div className="col-lg-8 ps-lg-5 mt-5 mt-lg-0">
                                        ...
                                        <div className="d-flex flex-wrap align-items-center gap-3 mt-7">
                                            <Link to="#" className="text-300 border border-1 px-3 py-1">Python</Link>
                                            <Link to="#" className="text-300 border border-1 px-3 py-1">TensorFlow</Link>
                                            <Link to="#" className="text-300 border border-1 px-3 py-1">Angular</Link>
                                            <Link to="#" className="text-300 border border-1 px-3 py-1">Kubernetes</Link>
                                            <Link to="#" className="text-300 border border-1 px-3 py-1">GCP</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <img className="position-absolute top-0 start-0 z-0" src="assets/imgs/home-page-2/services/bg.png" alt="khizar" />
                        </div>
                    </div>
                </div>
            </section>
