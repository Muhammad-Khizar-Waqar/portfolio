                                    ...
                                    <div className="p-lg-8 p-md-6 p-3">
                                        ...
                                        <div className="d-flex flex-column flex-md-row align-items-center gap-3">
                                                ...
                                                <div className="circle-1 position-relative z-0">
                                                    <div className="circle-2 position-absolute top-50 start-50 translate-middle z-1">
                                                        <div className="position-absolute top-50 start-50 translate-middle z-2">
                                                            <img className="w-100 h-100 rounded-circle" src="assets/imgs/coporation/avatar.png" alt="khizar" />
                                            ...
                                            <div className="d-flex flex-column gap-2">
                                                <a href="skype:Khizar.dev?chat">
                                                    <i className="ri-skype-fill" />
                                                    <span className="text-300">[skype] <span className="text-secondary-2">Khizar.dev</span></span>
                                                </a>
                                                <a href="tel:+12345678901">
                                                    <i className="ri-phone-fill" />
                                                    <span className="text-300">[phone] <span className="text-secondary-2">+1-234-567-8901</span></span>
                                                </a>
                                                <a href="mailto:contact@Khizar.dev">
                                                    <i className="ri-mail-fill" />
                                                    <span className="text-300">[email] <span className="text-secondary-2">contact@Khizar.dev</span></span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
