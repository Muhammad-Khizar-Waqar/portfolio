        ...
        <>
            <section id="about" className="section-hero-2 position-relative pt-130 pb-3">
                            ...
                            <div className="row align-items-end py-60">
                                <div className="col-lg-5 ps-lg-5 text-lg-start text-center">
                                    <div className="position-relative mb-lg-0 mb-5">
                                        <img src="assets/imgs/home-page-2/hero-1/people.png" alt="khizar" />
                                        <div className="position-absolute end-0 top-100 translate-middle-y icon-decorate">
                                            <img src="assets/imgs/home-page-2/hero-1/icon.svg" alt="khizar" />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-6 mx-lg-auto col-md-12">
                                    <div className="p-lg-0 p-md-8 p-3">
                                        <div className="text-secondary-2 d-flex align-items-center">
                                            ...
                                            <div className="text-dark">
                                                <div className="typewriter">
                                                    <h1 className="fs-6 fw-medium">Hey, I’m Khizar</h1>
                                                </div>
                                            </div>
                                            &lt;/span&gt;
                                        </div>
                                        ...
                                        <a href="assets/resume.pdf" className="btn me-2 text-300 ps-0 mt-4" target="_blank" rel="noopener noreferrer">
                ...
                <div className="background position-absolute top-0 start-0 w-100 h-100">
                    <img className="bg-w" src="assets/imgs/home-page-2/hero-1/bg.png" alt="khizar" />
                    <img className="bg-d" src="assets/imgs/home-page-2/hero-1/bg-dark.png" alt="khizar" />
                </div>
            </section>
        </>
    )
